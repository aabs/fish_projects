...
fd2_define_subcommand p2 del __fd2_p2_delete_project "delete project (by shortname)"
fd2_define_subcommand p2 delall __fd2_p2_delete_all_projects "delete every project"
